...
from Serializers.JsonSerialization import from_json, _json_to_dict, _json_to_list, _json_to_basic
...
def test_suite():
    ...
    suite.addTest(TestCustomJsonSerializer('from_json_throws_ex_test'))
    return suite
